...
class BtouchVideomatrix extends utils.Adapter {
	...
	async createStates() {
		...
		*/
		...
		await this.setObjectAsync('Labels.inputNames_Semicolon', {
			type: 'state',
			common: {
		...
		await this.setObjectAsync('Labels.outputNames_Semicolon', {
			type: 'state',
			common: {
				name: 'Off',
				type: 'string',
		...
		await this.setObjectAsync('Labels.inputValues_Semicolon', {
			type: 'state',
			common: {
				name: 'Autogenerated List for use in VIS',
				type: 'string',
		...
		await this.setObjectAsync('Labels.outputValues_Semicolon', {
			type: 'state',
			common: {
				name: 'Autogenerated List for use in VIS',
				type: 'string',
