...
class BtouchVideomatrix extends utils.Adapter {
	...
	async createStates() {
		...
		*/
		...
		await this.setObjectAsync('Labels.ListNamesInput_Semicolon', {
			type: 'state',
			common: {
		...
		await this.setObjectAsync('Labels.ListNamesOutput_Semicolon', {
			type: 'state',
			common: {
				name: 'Autogenerated List for use in VIS',
				type: 'string',
		...
		await this.setObjectAsync('Labels.ListValuesInput_Semicolon', {
			type: 'state',
			common: {
				name: 'Autogenerated List for use in VIS',
				type: 'string',
		...
		await this.setObjectAsync('Labels.ListValuesOutput_Semicolon', {
			type: 'state',
			common: {
				name: 'Autogenerated List for use in VIS',
				type: 'string',
